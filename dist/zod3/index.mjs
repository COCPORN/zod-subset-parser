    ...
    if (object.type === "Identifier" && object.name === "z") {
      ...
      switch (methodName) {
        ...
        case "date":
          ...
          return external_exports[methodName]();
        case "literal":
          return external_exports.literal(args[0]);
        case "enum":
          ...
          return external_exports.enum(enumValues);
        case "array":
          return external_exports.array(args[0]);
        case "object":
          return external_exports.object(args[0]);
        case "union":
          if (!Array.isArray(args[0]) || args[0].length < 2) {
            throw new ZodParseError("z.union() requires at least two arguments");
          }
          return external_exports.union(args[0]);
        case "tuple":
          return external_exports.tuple(args[0]);
        case "record":
          if (args.length === 1) {
            return external_exports.record(args[0]);
          } else if (args.length === 2) {
            return external_exports.record(args[0], args[1]);
          }
